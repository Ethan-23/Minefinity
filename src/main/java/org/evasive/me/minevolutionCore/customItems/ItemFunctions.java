...
import org.evasive.me.minevolutionCore.customItems.backpack.BaseBackpackItem;
import org.evasive.me.minevolutionCore.customItems.pickaxe.BasePickaxeComponent;
...
public class ItemFunctions {
    ...
    public static final NamespacedKey itemIDKey = new NamespacedKey(MinevolutionCore.getCore(), "ItemID");
    private static final NamespacedKey valueKey = new NamespacedKey(MinevolutionCore.getCore(), "Value");
    public static final NamespacedKey headKey = new NamespacedKey(MinevolutionCore.getCore(), "Head");
    public static final NamespacedKey coreKey = new NamespacedKey(MinevolutionCore.getCore(), "Core");
    public static final NamespacedKey handleKey = new NamespacedKey(MinevolutionCore.getCore(), "Handle");
