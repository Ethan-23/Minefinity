...
import org.evasive.me.minevolutionCore.utils.GenericGuiItems;
...
public class PickaxeAnvilGui extends BaseGui {
    ...
    public void updatePickaxeParts(){
        ...
        inventory.setItem(PICKAXE_SLOT,  new PickaxeAnvilHandler().updatePickaxeItem(pickaxe, head, core, handle));
    }
