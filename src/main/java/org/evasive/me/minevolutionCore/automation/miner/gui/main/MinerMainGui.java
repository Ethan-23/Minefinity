...
import static org.evasive.me.minevolutionCore.utils.GenericGuiItems.noneBarrier;
...
public class MinerMainGui extends BaseGui {
    ...
    private ItemStack createCollectButton(Player player){
        ...
        AutoMiner autoMiner = MinevolutionCore.playerManager.getPlayerData(player).getAutoMiner();
