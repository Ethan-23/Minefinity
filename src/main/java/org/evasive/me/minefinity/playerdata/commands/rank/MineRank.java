package org.evasive.me.minefinity.playerdata.commands.rank;
...
import org.evasive.me.minefinity.playerdata.commands.rank.sub.MineRankAddSub;
import org.evasive.me.minefinity.playerdata.commands.rank.sub.MineRankRemoveSub;
...
import org.evasive.me.minefinity.core.utils.command.TabCompletionUtils;
...
public class MineRank implements CommandExecutor, TabCompleter {
    ...
    public MineRank(RankService playerRankService) {
        Objects.requireNonNull(Minefinity.getCore().getCommand("minerank")).setExecutor(this);
        this.rankRegistry = RankRegistry.getInstance();

        register(new MineRankAddSub(playerRankService));
        register(new MineRankRemoveSub(playerRankService));
