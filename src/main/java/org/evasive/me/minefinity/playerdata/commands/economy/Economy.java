...
import static org.evasive.me.minefinity.core.utils.command.TabCompletionUtils.getOnlinePlayers;
...
public class Economy implements CommandExecutor, TabCompleter {
    ...
    public Economy(EconomyService economyService) {
        ...
        register(new EconomySetSub(economyService));
        register(new EconomyAddSub(economyService));
        register(new EconomySubSub(economyService));
