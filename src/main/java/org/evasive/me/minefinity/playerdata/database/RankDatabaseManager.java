...
public class RankDatabaseManager {
    ...
    private static RankDatabaseManager instance;
    private HikariDataSource dataSource;

    private RankDatabaseManager() {}

    public static RankDatabaseManager getInstance() {
        if (instance == null) instance = new RankDatabaseManager();
        return instance;
    }
