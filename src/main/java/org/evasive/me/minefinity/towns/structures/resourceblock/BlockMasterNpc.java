...
public class BlockMasterNpc implements NpcBehavior {
    ...
    public BlockMasterNpc(BlockTierService blockTierService, MilestoneService milestoneService, EconomyService economyService, CustomItemRegistryService customItemRegistryService) {
