...
public class MayorNpc implements NpcBehavior {
    ...
    public MayorNpc(CustomItemRegistryService customItemRegistryService, StructureService structureService, RecipeService recipeService, MiningMilestoneService milestoneService) {
