...
public class BaseCustomItem implements CustomItem {
    ...
    public <T> T getOrDefault(PersistentDataContainer pdc, NamespacedKey key, PersistentDataType<?,T> type, T def){
        ...
        return value == null || (type == PersistentDataType.STRING && value.equals("NONE")) ? def : value;
    }
    ...
    protected List<String> getLore() {
        ...
        lore.add(buildItemType(this.itemType.name()));
        lore.add("");
        lore.add(buildItemRarity(this.rarity));
