...
public enum SmelterRecipes {
    ...
    TIN_INGOT(Map.of(ResourceItem.RAW_TIN, 3), ResourceItem.TIN_INGOT, FuelItem.CHARCOAL, 2),
    IRON_INGOT(Map.of(ResourceItem.RAW_IRON, 3), ResourceItem.TIN_INGOT, FuelItem.COAL, 6),
    ;

    private final BaseSmelterRecipe recipe;

    SmelterRecipes(Map<CustomItem, Integer> recipe, CustomItem result, FuelItem requiredFuelTier, int fuelCost) {
        this.recipe = new BaseSmelterRecipe(recipe, result, requiredFuelTier, fuelCost);
    }
